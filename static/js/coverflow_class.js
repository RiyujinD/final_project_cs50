const images_playlist = [
  ...
  class CoverFlow {
    constructor(wrapperSelector, trackSelector, itemSelector, imagesData) {
      ...
      this.prevButton = document.querySelector("#previous_button");
    ...
    populateImages() {
      ...
      this.imagesList.forEach((imageObj) => {
        ...
        this.track.appendChild(item); // append to track
  
        item.style.setProperty("--cover-url", `url(${imageObj.url})`); // CSS variable for background image
  
        const metadataWrapper = document.createElement("div");
        metadataWrapper.classList.add("metadata_wrapper");
        item.appendChild(metadataWrapper); // Append to item
  
        const songTitle = document.createElement("div");
        songTitle.classList.add("metadata_songTitle");
        songTitle.textContent = imageObj.metadata; // Insert title
        metadataWrapper.appendChild(songTitle); // Append to metadataWrapper
  
        const artistName = document.createElement("div");
        artistName.classList.add("metadata_artist");
        artistName.textContent = imageObj.artist; // Insert artist name
